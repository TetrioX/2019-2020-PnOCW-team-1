...
let masterIo = io.of('/master').on('connect', function(socket){
    ...
    async function calibrate(numberOfRows, numberOfColumns) {
        ...
        const nbOfColorCombs = Object.keys(slaves).length * (numberOfRows * numberOfColumns + 2);
        ...
        Object.keys(slaves).forEach(function (slave, index) {
            ...
            const gridAndCombs = createColorGrid(numberOfRows, numberOfColumns, allColorCombinations, slaves[slave]);
