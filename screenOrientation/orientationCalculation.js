...
/**
 * Calculate the orientation of all given screens.
 **/
...
/**
 * Calculate the orientation of the given screen.
 **/
...
/**
 * Calculate the center of the given corners.
 **/ 
...
/**
 * Calculate the rotation matrix of the given corners.
 **/
...
depthTestNear = [{x:1920,y:0},{x:1920,y:1080},{x:0,y:1080},{x:0,y:0}]
depthTestFar = [{x:1920*2/3,y:1080/3},{x:1920*2/3,y:1080*2/3},{x:1920/3,y:1080*2/3},{x:1920/3,y:1080/3}]
...
testReal3 = [{x:2345, y: 1005},{x: 2717,y: 1705},{x: 1393,y: 2131},{x: 1001, y:1161}] 
...
result = getOrientation(testReal3)
console.log(result)
